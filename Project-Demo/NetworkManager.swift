...
//    func fetchWeatherData(for latitude: Double , longitude: Double, completion: @escaping(WeatherData)? -> void) {
//        let apiKey = ProcessInfo.processInfo.environment["apiKey"]!
//        
//        let apiUrlStr = "https://api.openweathermap.org/data/3.0/onecall?lat=\(latitude)&lon=\(longitude)&appid=\(apiKey)"
//        
//        guard let url = URL(string: apiUrlStr) else {
//            print("Invalid URL")
//            completion(nil)
